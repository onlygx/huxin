        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="btn-group">
                    ...
                    <a href="#module=targetSupervise/add" class="btn green">
            ...
            <c:forEach var="data" items="${pageInfo.list}" varStatus="status">
                <tr>
                    ...
                    <td>
                        ...
                        <a href="#module=targetSupervise/edit&id=${data.id}">查看\编辑</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
