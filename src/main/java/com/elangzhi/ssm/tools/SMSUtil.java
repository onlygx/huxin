...
public class SMSUtil {
    ...
    private static void send(String phone,String content){
        ...
        String username = "qhgh";  //用户名

        String password_md5 = "46c048cadc663f645b07c5dfa2328995";  //密码 asdf1234a

        String mobile = phone;  //手机号,只发一个号码：13800000001。发多个号码：13800000001,13800000002,...N 。使用半角逗号分隔。

        String apikey = "612d1a51fb80fefa9caece30e46a0eb7";  //apikey秘钥（请登录 http://m.5c.com.cn 短信平台-->账号管理-->我的信息 中复制apikey）
